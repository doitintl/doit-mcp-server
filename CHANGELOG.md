...
- fix: tool error messages is now valid MCP error response (`65ec4bf`)
...
- chore: biomjs format and lint integrations tests (`16855e6`)
- chore: add integration test setup for stdio server (`b6479d6`)
- chore: improve tests, mock consol.error to prevent stderr messages (`03b743e`)
