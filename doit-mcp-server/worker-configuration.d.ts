/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5d690f9fdb3cfdb9e45050f80e889a47)
// Runtime types generated with workerd@1.20260317.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DoitMCPAgent" | "ContextStorage";
	}
	interface DevEnv {
		ASSETS: Fetcher;
		WORKER_URL: "https://doit-mcp-server-dev.doitintl.workers.dev";
		PUBLIC_MCP_URL: "https://doit-mcp-server-dev.doitintl.workers.dev/sse";
		MCP_RESOURCE_URL: "https://doit-mcp-server-dev.doitintl.workers.dev/";
		AUTH_SERVER_URL: "https://dev-app.doit.com";
		DOIT_API_BASE: "https://api-dev.doit.com";
		MCP_TOKEN_EXCHANGE_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").DoitMCPAgent>;
		CONTEXT_STORAGE: DurableObjectNamespace<import("./src/index").ContextStorage>;
	}
	interface Env {
		ASSETS: Fetcher;
		WORKER_URL: "https://doit-mcp-server-dev.doitintl.workers.dev" | "https://mcp.doit.com";
		PUBLIC_MCP_URL: "https://doit-mcp-server-dev.doitintl.workers.dev/sse" | "https://mcp.doit.com/sse";
		MCP_RESOURCE_URL: "https://doit-mcp-server-dev.doitintl.workers.dev/" | "https://mcp.doit.com";
		AUTH_SERVER_URL: "https://dev-app.doit.com" | "https://console.doit.com";
		DOIT_API_BASE?: "https://api-dev.doit.com";
		MCP_TOKEN_EXCHANGE_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").DoitMCPAgent>;
		CONTEXT_STORAGE: DurableObjectNamespace<import("./src/index").ContextStorage>;
		CONSOLE_PROXY?: Fetcher /* console-worker-console */;
	}
}
