...
import { formatAnomaly, handleAnomaliesRequest, handleAnomalyRequest } from "../anomalies.js";
...
-----------`;
    ...
    describe("handleAnomaliesRequest", () => {
        ...
        it("should handle no anomalies found", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith("https://api.doit.com/anomalies/v1?maxResults=20", mockToken, {
                method: "GET",
            });
        ...
        it("should handle API request failure", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith("Failed to retrieve anomalies data");
            expect(response).toEqual({
    ...
    describe("handleAnomalyRequest", () => {
        ...
        it("should call makeDoitRequest with correct parameters and return success response", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith("https://api.doit.com/anomalies/v1/anomaly-123", mockToken, {
                appendParams: true,
                method: "GET",
            });
        ...
        it("should handle API request failure", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith("Failed to retrieve anomaly with ID: anomaly-123");
            expect(response).toEqual({
                content: [
                    {
                        type: "text",
