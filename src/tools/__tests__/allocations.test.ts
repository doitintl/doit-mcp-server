...
describe("allocations", () => {
    ...
    describe("handleListAllocationsRequest", () => {
        it("should call makeDoitRequest with correct parameters and return success response", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith(`${ALLOCATIONS_URL}?pageToken=next-page`, mockToken, {
                method: "GET",
            });
            expect(createSuccessResponse).toHaveBeenCalledWith(expect.stringContaining("allocation-1"));
        });
        ...
        it("should handle request without pageToken", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith(ALLOCATIONS_URL, mockToken, {
                method: "GET",
            });
        ...
        it("should handle API request failure", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith("Failed to retrieve allocations data");
        });
    ...
    describe("handleGetAllocationRequest", () => {
        it("should call makeDoitRequest with correct parameters and return success response", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith(`${ALLOCATIONS_URL}/allocation-123`, mockToken, {
                method: "GET",
            });
            expect(createSuccessResponse).toHaveBeenCalledWith(expect.stringContaining("allocation-123"));
        });
        ...
        it("should handle API request failure", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith("Failed to retrieve allocation data");
        });
    ...
    describe("handleCreateAllocationRequest", () => {
        const singleRuleArgs = {
            ...
            rule: {
                components: [{ key: "environment", type: "label" as const, values: ["prod"], mode: "is" as const }],
                formula: "A",
            },
        };
            ...
            rules: [
                {
                    ...
                    components: [{ key: "team", type: "label" as const, values: ["team-a"], mode: "is" as const }],
                    formula: "A",
                },
                {
                    name: "Team B",
                    action: "create" as const,
                    components: [{ key: "team", type: "label" as const, values: ["team-b"], mode: "is" as const }],
                    formula: "A",
                },
            ],
        ...
        it("should send rule in body for single-rule allocation", async () => {
            ...
            expect(createSuccessResponse).toHaveBeenCalledWith(expect.stringContaining("alloc-new-1"));
        });
        ...
        it("should send rules + unallocatedCosts in body for group allocation", async () => {
            ...
            expect(createSuccessResponse).toHaveBeenCalledWith(expect.stringContaining("alloc-new-2"));
        });
        ...
        it("should return error when API returns null", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith(expect.stringContaining("Failed to create allocation"));
        });
    ...
    describe("handleUpdateAllocationRequest", () => {
        const singleRuleArgs = {
            ...
            rule: {
                components: [{ key: "environment", type: "label" as const, values: ["staging"], mode: "is" as const }],
                formula: "A",
            },
        };
        ...
        it("should send PATCH request with rules + unallocatedCosts for group allocation", async () => {
            ...
            expect(makeDoitRequest).toHaveBeenCalledWith(`${ALLOCATIONS_URL}/allocation-456`, mockToken, {
                method: "PATCH",
                body: {
                    name: "Updated Group",
                    description: "Updated group allocation",
            ...
            expect(createSuccessResponse).toHaveBeenCalledWith(expect.stringContaining("allocation-456"));
        });
        ...
        it("should return error when API returns null", async () => {
            ...
            expect(createErrorResponse).toHaveBeenCalledWith(expect.stringContaining("Failed to update allocation"));
        });
