...
export const listTicketsTool = {
    name: "list_tickets",
    coversEndpoint: { method: "get", path: "/support/v1/tickets" },
    description:
...
export const createTicketTool = {
    name: "create_ticket",
    coversEndpoint: { method: "post", path: "/support/v1/tickets" },
    description:
...
export const getTicketTool = {
    name: "get_ticket",
    coversEndpoint: { method: "get", path: "/support/v1/tickets/{ticketId}" },
