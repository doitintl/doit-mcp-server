...
export const findCloudDiagramsTool = {
    ...
    coversEndpoint: { method: "post", path: "/clouddiagrams/v1/scheme/find" },
    description:
...
export const getCloudDiagramsStatsTool = {
    ...
    coversEndpoint: { method: "get", path: "/clouddiagrams/v1/scheme/stats" },
    description:
...
export const searchCloudDiagramsTool = {
    ...
    coversEndpoint: { method: "post", path: "/clouddiagrams/v1/scheme/search" },
    description:
...
export const listCloudDiagramActivityGroupsTool = {
    ...
    coversEndpoint: { method: "get", path: "/clouddiagrams/v1/activity" },
    description:
...
export const listCloudDiagramNodeActivitiesTool = {
    ...
    coversEndpoint: {
        method: "get",
        path: "/clouddiagrams/v1/activity/node-activities",
    },
    description:
...
export const getCloudDiagramComponentsTool = {
    ...
    coversEndpoint: { method: "post", path: "/clouddiagrams/v1/scheme/get" },
    description:
