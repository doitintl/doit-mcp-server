...
beforeEach(() => {
    ...
    _stdioTransportSpy = vi.spyOn(require("@modelcontextprotocol/sdk/server/stdio.js"), "StdioServerTransport");
...
describe("CallToolRequestSchema Handler", () => {
    ...
    it("should route to the correct tool handler for get_cloud_incidents", async () => {
        ...
        expect(indexModule.handleCloudIncidentsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for get_cloud_incident", async () => {
        ...
        expect(indexModule.handleCloudIncidentRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for get_anomalies", async () => {
        ...
        expect(indexModule.handleAnomaliesRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for get_anomaly", async () => {
        ...
        expect(indexModule.handleAnomalyRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for list_reports", async () => {
        ...
        expect(indexModule.handleReportsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for run_query", async () => {
        ...
        expect(indexModule.handleRunQueryRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for get_report_results", async () => {
        ...
        expect(indexModule.handleGetReportResultsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for validate_user", async () => {
        ...
        expect(indexModule.handleValidateUserRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for list_dimensions", async () => {
        ...
        expect(indexModule.handleDimensionsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for get_dimension", async () => {
        ...
        expect(indexModule.handleDimensionRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for list_tickets", async () => {
        ...
        expect(indexModule.handleListTicketsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should route to the correct tool handler for list_allocations", async () => {
        ...
        expect(handleListAllocationsRequest).toHaveBeenCalledWith(args, "fake-token");
    });
    ...
    it("should handle general errors during tool request handling", async () => {
        ...
        expect(indexModule.handleGeneralError).toHaveBeenCalledWith(expect.any(Error), "handling tool request");
        expect(response).toEqual({
